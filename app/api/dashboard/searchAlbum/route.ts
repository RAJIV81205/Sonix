...
export async function POST(request: Request) {
    try {
        ...
        const response = await fetch(`https://www.jiosaavn.com/api.php?p=1&q=${encodeURIComponent(query)}&_format=json&_marker=0&api_version=4&ctx=wap6dot0&n=20&__call=search.getAlbumResults`, {
            method: "GET",
