          ...
          <div className="flex justify-between items-center mb-6">
            <div className="flex items-center gap-3">
              <div className="bg-gray-600 p-2 rounded-full">
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/19/Spotify_logo_without_text.svg/2048px-Spotify_logo_without_text.svg.png" alt="spotify-logo" className="w-6 h-6" />
              </div>
          ...
          {!importedPlaylist ? (
            ...
            <div className="flex-1 flex flex-col items-center justify-center">
              <div className="w-full max-w-2xl">
                <div className="bg-zinc-800 p-6 rounded-full mb-6 w-20 h-20 flex items-center justify-center mx-auto">
                  <Link className="w-10 h-10 text-green-500" />
                </div>
                <h3 className="text-xl font-semibold text-white mb-3 text-center">Import from URL</h3>
              ...
              <div className="flex items-start gap-6 mb-6">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center text-zinc-500 text-sm">
                    ...
                    <span className="mx-1">•</span>
                    <span>{importedPlaylist.followers} followers</span>
                  </div>
                </div>
              </div>
