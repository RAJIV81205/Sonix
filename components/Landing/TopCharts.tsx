        ...
        <div className="flex flex-col md:flex-row items-center md:items-end justify-between mb-12">
          <div>
            <div className="flex items-center gap-2 text-purple-500 mb-3">
              <TrendingUp size={18} />
              <span className="text-sm font-medium uppercase tracking-wider">Popular Now</span>
            </div>
            <h2 className="text-3xl md:text-4xl font-bold text-white">Top Charts</h2>
            <p className="text-gray-400 mt-2 max-w-lg">
              The hottest tracks trending right now on our platform
            </p>
          </div>
          
          <a href="#" className="mt-6 md:mt-0 text-purple-400 hover:text-purple-300 flex items-center gap-2 group transition duration-300">
