...
export const SongAPIResponseModel = z.object({
  ...
  button_tooltip_info: z.array(z.any()).optional()
})
...
export type Song = z.infer<typeof SongModel>
export type SongAPIResponse = z.infer<typeof SongAPIResponseModel>
export type ArtistMap = z.infer<typeof ArtistMapModel>
export type DownloadLink = z.infer<typeof DownloadLinkModel>